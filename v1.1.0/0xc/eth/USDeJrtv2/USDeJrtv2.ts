 ...
 *  Implementation: https://etherscan.io/address/0xe91869F96806b480dd61d57E17919068d35AC09C#code
 */
import di from 'a-di';
...
export namespace USDeJrtv2Errors {
...
export class USDeJrtv2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0xe91869F96806b480dd61d57E17919068d35AC09C',
        ...
        this.storage = new USDeJrtv2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TUSDeJrtv2Types;

    $meta = {
        "class": "./0xc/eth/USDeJrtv2/USDeJrtv2.ts"
    }
    ...
    $call () {
        return super.$call() as IUSDeJrtv2TxCaller;
    }
    $signed (): TOverrideReturns<IUSDeJrtv2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IUSDeJrtv2TxData {
        return super.$data() as IUSDeJrtv2TxData;
    }
    $gas (): TOverrideReturns<IUSDeJrtv2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TUSDeJrtv2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TUSDeJrtv2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    declare storage: USDeJrtv2StorageReader
}
...
class USDeJrtv2StorageReader extends ContractStorageReaderBase {
    constructor(
...
type TEvents = TUSDeJrtv2Types['Events'];
