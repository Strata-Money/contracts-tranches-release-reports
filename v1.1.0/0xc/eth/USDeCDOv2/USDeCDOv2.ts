 ...
 *  Implementation: https://etherscan.io/address/0xb3d4f2C2123f8C3CA85aE7A6D48aA2ef049c79bA#code
 */
import di from 'a-di';
...
export namespace USDeCDOv2Errors {
...
export class USDeCDOv2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0xb3d4f2C2123f8C3CA85aE7A6D48aA2ef049c79bA',
        ...
        this.storage = new USDeCDOv2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TUSDeCDOv2Types;

    $meta = {
        "class": "./0xc/eth/USDeCDOv2/USDeCDOv2.ts"
    }
    ...
    // 0x5fd7d7b6
    async calculateExitFee (tranche: TAddress, amount: bigint, isGross: boolean): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'calculateExitFee'), tranche, amount, isGross);
    }
    ...
    $call () {
        return super.$call() as IUSDeCDOv2TxCaller;
    }
    $signed (): TOverrideReturns<IUSDeCDOv2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IUSDeCDOv2TxData {
        return super.$data() as IUSDeCDOv2TxData;
    }
    $gas (): TOverrideReturns<IUSDeCDOv2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TUSDeCDOv2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TUSDeCDOv2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TUSDeCDOv2Types = {
    ...
    Methods: {
        ...
        calculateExitFee: {
          method: "calculateExitFee"
          arguments: [ tranche: TAddress, amount: bigint, isGross: boolean ]
        }
        configure: {
          method: "configure"
...
class USDeCDOv2StorageReader extends ContractStorageReaderBase {
    constructor(
...
type TEvents = TUSDeCDOv2Types['Events'];
