 ...
 *  Implementation: https://etherscan.io/address/0x3d7d6fdf07EE548B939A80edbc9B2256d0cdc003#code
 */
import di from 'a-di';
...
export namespace USDeSrtv1Errors {
...
export class USDeSrtv1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x3d7d6fdf07EE548B939A80edbc9B2256d0cdc003',
        ...
        this.storage = new USDeSrtv1StorageReader(this.address, this.client, this.explorer);
    }

    Types: TUSDeSrtv1Types;

    $meta = {
        "class": "./0xc/eth/USDeSrtv1/USDeSrtv1.ts"
    }
    ...
    $call () {
        return super.$call() as IUSDeSrtv1TxCaller;
    }
    $signed (): TOverrideReturns<IUSDeSrtv1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IUSDeSrtv1TxData {
        return super.$data() as IUSDeSrtv1TxData;
    }
    $gas (): TOverrideReturns<IUSDeSrtv1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TUSDeSrtv1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TUSDeSrtv1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    declare storage: USDeSrtv1StorageReader
}
...
class USDeSrtv1StorageReader extends ContractStorageReaderBase {
    constructor(
...
type TEvents = TUSDeSrtv1Types['Events'];
