 ...
 *  Implementation: https://etherscan.io/address/0x74188a2a8A5177dD217a8149F1fB1370240FBadc#code
 */
import di from 'a-di';
...
export namespace SUSDeAprFeedsv2Errors {
...
export class SUSDeAprFeedsv2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x74188a2a8A5177dD217a8149F1fB1370240FBadc',
        ...
        this.storage = new SUSDeAprFeedsv2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TSUSDeAprFeedsv2Types;

    $meta = {
        "class": "./0xc/eth/sUSDeAprFeedsv2/sUSDeAprFeedsv2.ts"
    }
    ...
    $call () {
        return super.$call() as ISUSDeAprFeedsv2TxCaller;
    }
    $signed (): TOverrideReturns<ISUSDeAprFeedsv2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ISUSDeAprFeedsv2TxData {
        return super.$data() as ISUSDeAprFeedsv2TxData;
    }
    $gas (): TOverrideReturns<ISUSDeAprFeedsv2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TSUSDeAprFeedsv2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TSUSDeAprFeedsv2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    declare storage: SUSDeAprFeedsv2StorageReader
}
...
export type TSUSDeAprFeedsv2Types = {
    Events: {
        AnswerUpdated: {
...
class SUSDeAprFeedsv2StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ISUSDeAprFeedsv2TxCaller {
...
interface ISUSDeAprFeedsv2TxData {
...
type TEvents = TSUSDeAprFeedsv2Types['Events'];
