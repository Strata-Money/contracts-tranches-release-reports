 ...
 *  Implementation: https://etherscan.io/address/0x0dA391431cC9760005c113c1A2dcb9D67878F213#code
 */
import di from 'a-di';
...
export namespace SUSDeStrategyv1Errors {
...
export class SUSDeStrategyv1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x0dA391431cC9760005c113c1A2dcb9D67878F213',
        ...
        this.storage = new SUSDeStrategyv1StorageReader(this.address, this.client, this.explorer);
    }

    Types: TSUSDeStrategyv1Types;

    $meta = {
        "class": "./0xc/eth/SUSDeStrategyv1/SUSDeStrategyv1.ts"
    }
    ...
    $call () {
        return super.$call() as ISUSDeStrategyv1TxCaller;
    }
    $signed (): TOverrideReturns<ISUSDeStrategyv1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ISUSDeStrategyv1TxData {
        return super.$data() as ISUSDeStrategyv1TxData;
    }
    $gas (): TOverrideReturns<ISUSDeStrategyv1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TSUSDeStrategyv1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TSUSDeStrategyv1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TSUSDeStrategyv1Types = {
    Events: {
        CooldownsChanged: {
...
class SUSDeStrategyv1StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ISUSDeStrategyv1TxCaller {
...
interface ISUSDeStrategyv1TxData {
...
type TEvents = TSUSDeStrategyv1Types['Events'];
