 ...
 *  Implementation: https://etherscan.io/address/0x6e5a69BFDcE6b521DF6b2D0d3c49610C8f26B20b#code
 */
import di from 'a-di';
...
export namespace TrancheDepositorV2v2Errors {
...
export class TrancheDepositorV2v2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x6e5a69BFDcE6b521DF6b2D0d3c49610C8f26B20b',
        ...
        this.storage = new TrancheDepositorV2v2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TTrancheDepositorV2v2Types;

    $meta = {
        "class": "./0xc/eth/TrancheDepositorV2v2/TrancheDepositorV2v2.ts"
    }
    ...
    $call () {
        return super.$call() as ITrancheDepositorV2v2TxCaller;
    }
    $signed (): TOverrideReturns<ITrancheDepositorV2v2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ITrancheDepositorV2v2TxData {
        return super.$data() as ITrancheDepositorV2v2TxData;
    }
    $gas (): TOverrideReturns<ITrancheDepositorV2v2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TTrancheDepositorV2v2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TTrancheDepositorV2v2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TTrancheDepositorV2v2Types = {
    Events: {
...
class TrancheDepositorV2v2StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ITrancheDepositorV2v2TxCaller {
...
interface ITrancheDepositorV2v2TxData {
...
type TEvents = TTrancheDepositorV2v2Types['Events'];
