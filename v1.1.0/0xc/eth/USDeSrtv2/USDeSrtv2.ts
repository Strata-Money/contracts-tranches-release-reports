/**
 *  AUTO-Generated Class: 2025-11-27 18:26
 *  Implementation: https://etherscan.io/address/0xE894055CA1c73648927e225f3Ca38Ed48E30210b#code
 */
import di from 'a-di';
...
export namespace USDeSrtv2Errors {
...
export class USDeSrtv2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0xE894055CA1c73648927e225f3Ca38Ed48E30210b',
        ...
        this.storage = new USDeSrtv2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TUSDeSrtv2Types;

    $meta = {
        "class": "./0xc/eth/USDeSrtv2/USDeSrtv2.ts"
    }
    ...
    async maxDeposit (token: TAddress, owner: TAddress): Promise<bigint>
        async maxDeposit (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload([ 'function maxDeposit(address) returns uint256', 'function maxDeposit(address, address) returns uint256' ], args);
    ...
    async maxWithdraw (owner: TAddress): Promise<bigint>
        async maxWithdraw (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload([ 'function maxWithdraw(address, address) returns uint256', 'function maxWithdraw(address) returns uint256' ], args);
            return this.$read(abi, ...args);
        }
    ...
    async previewDeposit (assets: bigint): Promise<bigint>
        async previewDeposit (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload([ 'function previewDeposit(address, uint256) returns uint256', 'function previewDeposit(uint256) returns uint256' ], args);
            return this.$read(abi, ...args);
        }
    ...
    async previewMint (token: TAddress, shares: bigint): Promise<bigint>
        async previewMint (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload([ 'function previewMint(uint256) returns uint256', 'function previewMint(address, uint256) returns uint256' ], args);
            return this.$read(abi, ...args);
        }
    ...
    async previewRedeem (token: TAddress, shares: bigint): Promise<bigint>
        async previewRedeem (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload([ 'function previewRedeem(uint256) returns uint256', 'function previewRedeem(address, uint256) returns uint256' ], args);
            return this.$read(abi, ...args);
        }
    ...
    async previewWithdraw (token: TAddress, tokenAmount: bigint): Promise<bigint>
        async previewWithdraw (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload([ 'function previewWithdraw(uint256) returns uint256', 'function previewWithdraw(address, uint256) returns uint256' ], args);
            return this.$read(abi, ...args);
        }
    ...
    $call () {
        return super.$call() as IUSDeSrtv2TxCaller;
    }
    $signed (): TOverrideReturns<IUSDeSrtv2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IUSDeSrtv2TxData {
        return super.$data() as IUSDeSrtv2TxData;
    }
    $gas (): TOverrideReturns<IUSDeSrtv2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TUSDeSrtv2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TUSDeSrtv2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TUSDeSrtv2Types = {
    ...
    Methods: {
        ...
        maxDeposit: {
          method: "maxDeposit"
          arguments: [ owner: TAddress ] | [ token: TAddress, owner: TAddress ]
        }
        maxMint: {
          method: "maxMint"
...
class USDeSrtv2StorageReader extends ContractStorageReaderBase {
    constructor(
...
type TEvents = TUSDeSrtv2Types['Events'];
